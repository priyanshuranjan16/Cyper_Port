                    ...
                    <div className="grid grid-cols-3 gap-4">
                        {[
                            ...
                            { icon: Github, label: "REPO", href: "https://github.com", delay: 0.2 },
                             { icon: LeetCodeIcon, label: "CODE", href: "https://leetcode.com", delay: 0.4 },
                            { icon: Linkedin, label: "NETWORK", href: "https://linkedin.com", delay: 0.3 },
                            { icon: XIcon, label: "X", href: "https://x.com", delay: 0.5 },
                            { icon: Instagram, label: "INSTA", href: "https://instagram.com", delay: 0.6 },
                        ].map((item) => (
                            <motion.a
                                key={item.label}
                                href={item.href}
